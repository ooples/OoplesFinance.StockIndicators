...
public static partial class Calculations
{
        ...
        int length2 = 200, int smoothLength = 8, decimal stdDevMult = 1.6m)
    {
        ...
        for (int i = 0; i < stockData.Count; i++)
        {
            ...
            decimal currentLow = lowList.ElementAtOrDefault(i);
            decimal currentValue = inputList.ElementAtOrDefault(i);
            decimal prevOhlc = i >= 1 ? inputList.ElementAtOrDefault(i - 1) : 0;
        ...
        for (int i = 0; i < stockData.Count; i++)
        {
            decimal zihaTema = zlhaTemaList.ElementAtOrDefault(i);
            decimal zihaTemaStdDev = zlhaTemaStdDevList.ElementAtOrDefault(i);
            decimal wmaZihaTema = wmaZlhaTemaList.ElementAtOrDefault(i);
        ...
        for (int i = 0; i < stockData.Count; i++)
        {
            ...
            decimal percbStdDev = percbStdDevList.ElementAtOrDefault(i);
            decimal prevValue = i >= 1 ? percbList.ElementAtOrDefault(i - 1) : 0;
